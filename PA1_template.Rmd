...
To find out the average daily activity pattern, we aggregate the data on a 5-minute-interval basis. A time series plot will help observe how the steps taken during intervals vary across the day. Again here we ignore the missing values.
```{r, echo=T}
